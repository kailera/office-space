...
export default function FloatingPanelProject({
  projects,
}: IFloatingPanelProject) {
  ...
  `}
      ...
      <div
        ...
        } w-[90vw] sm:w-72 dark:bg-zinc-900 shadow-lg rounded-lg p-3 max-h-[80vh] sm:max-h-[60vh] overflow-hidden`}
      >
